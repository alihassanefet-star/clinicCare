...
function renderDoctorProfile(doctor) {
    ...
    let image = doctor.image || "images/default-avatar.png";
    ...
    if (Array.isArray(doctor.beforeAfterImages) && doctor.beforeAfterImages.length > 0) {
...
function initializeBookButton() {
    ...
    let button = document.getElementById("bookAppointmentBtn");
...
function showInvalidDoctor() {
    ...
    <div class="alert alert-danger text-center">
        ...
        <h4>Invalid Doctor ID</h4>

        <a href="doctors.html" class="btn btn-primary">
            Back To Doctors
        </a>
...
function showLoadError() {
    ...
    <div class="alert alert-danger text-center">
        ...
        <h4>Unable To Load Doctors Data</h4>
